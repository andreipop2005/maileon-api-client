 ...
 */
class com_maileon_api_contacts_ContactsService extends com_maileon_api_AbstractMaileonService
{
                           ...
                           $subscriptionPage = "", $doi = FALSE, $doiPlus = FALSE, $doiMailingKey = "")
    {
        ...
        if (!empty(trim($doiMailingKey))) {
            $queryParameters['doimailing'] = trim($doiMailingKey);
        }
        ...
        $contactToSend = new com_maileon_api_contacts_Contact(null, $contact->email, null, $contact->external_id, null, $contact->standard_fields, $contact->custom_fields);
    ...
    function updateContact($contact, $checksum = "", $src = null, $subscriptionPage = null, $triggerDoi = FALSE, $doiMailingKey = null, $ignoreChecksum = false)
    {
        ...
        if (!empty(trim($doiMailingKey))) $queryParameters['doimailing'] = trim($doiMailingKey);
    ...
    function synchronizeContacts($contacts, $permission = null, $syncMode = null, $useExternalId = false, $ignoreInvalidContacts = false, $reimportUnsubscribedContacts = true, $overridePermission = true, $updateOnly = false, $preferMaileonId = false)
    {
        ...
        $cleanedContacts = new com_maileon_api_contacts_Contacts();
        foreach ($contacts as $contact) {
            $cleanedContact = new com_maileon_api_contacts_Contact($contact->id, $contact->email, null, $contact->external_id, null, $contact->standard_fields, $contact->custom_fields);
