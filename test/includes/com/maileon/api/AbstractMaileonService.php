 ...
 */
abstract class com_maileon_api_AbstractMaileonService
{
    ...
    private function performRequest($curlSession, $deserializationType = null)
    {
        ...
        try {
            $result = new com_maileon_api_MaileonAPIResult($response, $curlSession, $this->throwException, $deserializationType);
