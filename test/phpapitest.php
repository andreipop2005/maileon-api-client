<?php
	...
	require_once('./includes/MaileonApiClient.php');	
	
	// This enables general debugging
	XQDebug::setDebug(false);
	
	if(!@include("./conf/config.php")) die("'conf/config.php' not found. Make sure you created a config file and placed it there.");
	if(!@include("./conf/testdata.include")) die("'conf/testdata.include' not found. Make sure you copied it there.");
	...
	$notUsed = com_maileon_api_HTTPResponseCodes::getStringFromHTTPStatusCode(200);
...
<?php
	$pingService = new com_maileon_api_utils_PingService($config); 
...
<?php 
if (isset($_POST['contact_1'])
	|| isset($_POST['contact_1_1'])
	|| isset($_POST['contact_1_2'])
	|| isset($_POST['contact_2'])
	|| isset($_POST['contact_3'])
	|| isset($_POST['contact_4'])
	|| isset($_POST['contact_5'])
	|| isset($_POST['contact_6'])
	|| isset($_POST['contact_7'])
	|| isset($_POST['contact_8'])
	|| isset($_POST['contact_81'])
	|| isset($_POST['contact_82'])
	|| isset($_POST['contact_83'])
	|| isset($_POST['contact_9'])
	|| isset($_POST['contact_10'])
	|| isset($_POST['contact_101'])
	|| isset($_POST['contact_102'])
	|| isset($_POST['contact_103'])
	|| isset($_POST['contact_11'])
	|| isset($_POST['contact_12'])
	|| isset($_POST['contact_13'])
	|| isset($_POST['contact_14'])
	|| isset($_POST['contact_15'])
	|| isset($_POST['contact_16'])
	|| isset($_POST['contact_17'])
	|| isset($_POST['contact_18'])
	|| isset($_POST['contact_19'])
	|| isset($_POST['contact_20'])
) {?>
<h2>Contact - Tests</h2>
...
<?php
	...
	// Not really required but used as the classloader currently prints first time a class is loaded and it looks ugly if the class is loaded in between
	$notUsed = new com_maileon_api_contacts_Contact();
?>
...
<?php
	...
	$newContact->email = "marcus.staender@xqueue.com";//$TESTDATA['userEmail'];
	$newContact->external_id = $TESTDATA['external_id'];
	$newContact->permission = com_maileon_api_contacts_Permission::$SOI;

	//$newContact->custom_fields['someKey'] = "someVal";
	$newContact->standard_fields[com_maileon_api_contacts_StandardContactField::$FIRSTNAME] = "Marcus";
	$newContact->standard_fields[com_maileon_api_contacts_StandardContactField::$LASTNAME] = "Ständer";
	$newContact->standard_fields[com_maileon_api_contacts_StandardContactField::$ZIP] = "1337";
	$newContact->standard_fields[com_maileon_api_contacts_StandardContactField::$SALUTATION] = "Herr";
	$newContact->standard_fields[com_maileon_api_contacts_StandardContactField::$COUNTRY] = "De";
	$newContact->standard_fields[com_maileon_api_contacts_StandardContactField::$ADDRESS] = "Christian-Pless-Straße";
	$newContact->standard_fields[com_maileon_api_contacts_StandardContactField::$CITY] = "Offenbach";
	$newContact->standard_fields[com_maileon_api_contacts_StandardContactField::$HNR] = "11-13";
	$newContact->standard_fields[com_maileon_api_contacts_StandardContactField::$BIRTHDAY] = "04.06.1982";
...
//	$newContact->custom_fields["Telefonnummer"] = "069-830089820";
	...
	$response = $contactsService->createContact($newContact, com_maileon_api_contacts_SynchronizationMode::$UPDATE, "src", "subscriptionPage", false, false);//, $TESTDATA['doiMailingKey']);
	checkResult($response);
	...
	$nc = new com_maileon_api_contacts_Contact();
...
<?php
	...
	$newContact->standard_fields[com_maileon_api_contacts_StandardContactField::$LASTNAME] = "<test>";
	
	$response = $contactsService->createContactByExternalId($newContact, com_maileon_api_contacts_SynchronizationMode::$UPDATE, "src", "subscriptionPage", true, true, $TESTDATA['doiMailingKey']);
	checkResult($response);
?>
</li>
...
<?php } if (isset($_POST['contact_1_2'])) { ?>
	<li>
		...
		$updateContact = new com_maileon_api_contacts_Contact();
		$updateContact->anonymous = FALSE;
		$updateContact->id = 1328960;
		$updateContact->email = "marcus.beckerle@xqueue.com";
		$updateContact->permission = com_maileon_api_contacts_Permission::$NONE;

		//$newContact->custom_fields['someKey'] = "someVal";
		$updateContact->standard_fields[com_maileon_api_contacts_StandardContactField::$FIRSTNAME] = "FirstName";
		$updateContact->standard_fields[com_maileon_api_contacts_StandardContactField::$LASTNAME] = "Test";
...
<?php
	...
	$newUpdateContact = new com_maileon_api_contacts_Contact();
	$newUpdateContact->id = 196837;
//	$newUpdateContact->external_id = $TESTDATA['userExternalId']."_updated";
	$newUpdateContact->standard_fields[com_maileon_api_contacts_StandardContactField::$FIRSTNAME] = "Marcus";
...
<?php
	$response = $contactsService->unsubscribeContactByEmail("marcus.staender@xqueue.com", null, array("too_many_messages", "Deployment-Tests rock."));
...
<?php } if (isset($_POST['contact_20'])) { ?>
	<li>
		...
		$contactsToSyncTmp = new com_maileon_api_contacts_Contacts();
		for ($i=0; $i<10000; $i++) {
			$contactsToSyncTmp->addContact(new com_maileon_api_contacts_Contact(null,
...
<?php 
if (isset($_POST['contactfilter_1'])
	|| isset($_POST['contactfilter_2'])
	|| isset($_POST['contactfilter_3'])
	|| isset($_POST['contactfilter_4'])
	|| isset($_POST['contactfilter_5'])
	|| isset($_POST['contactfilter_6'])
	|| isset($_POST['contactfilter_7'])) {?>
...
<?php
	...
	// Not really required but used as the classloader currently prints first time a class is loaded and it looks ugly if the class is loaded in between
	$notUsed = new com_maileon_api_contactfilters_ContactFilter();
?>
...
<?php
	$filter = new com_maileon_api_contactfilters_ContactFilter($TESTDATA['contactFilterId'], "Some-NEW-Name", "xq-freiburg@xqueue.com", 12, 1, "2013-10-15 10:48:38", "uptodate");
...
<?php } if (isset($_POST['contactfilter_6'])) { ?>
	<li>
		...
		$filter = new com_maileon_api_contactfilters_ContactFilter($TESTDATA['contactFilterId'], "testfilterNEU2", "xq-freiburg@xqueue.com");

		//$filter->addRule(new com_maileon_api_contactfilters_Rule(false, com_maileon_api_contacts_StandardContactField::$FIRSTNAME, "EQUALS", "Marcus"));

		$filter->addRule(new com_maileon_api_contactfilters_Rule(true, "createdByTransaction", "EQUALS", "true", "boolean"));
		//$filter->addRule(new com_maileon_api_contactfilters_Rule(true, "Test123", "EQUALS", "weee"));
...
<?php } if (isset($_POST['contactfilter_7'])) { ?>
	<li>
		...
		$filter = new com_maileon_api_contactfilters_ContactFilter($TESTDATA['contactFilterId'], "testfilterNEU2", "xq-freiburg@xqueue.com");
		$filter->addRule(new com_maileon_api_contactfilters_Rule(false, com_maileon_api_contacts_StandardContactField::$FIRSTNAME, "EQUALS", "Max"));
		$response = $contactfiltersService->createContactFilter($filter, false);
...
<?php
if (isset($_POST['targetgroup_1'])
	|| isset($_POST['targetgroup_2'])
	|| isset($_POST['targetgroup_3'])
	|| isset($_POST['targetgroup_4'])
    || isset($_POST['targetgroup_5'])) {?>
<h2>TargetGroup - Tests</h2>

<?php
	$targetGroupsService = new com_maileon_api_targetgroups_TargetGroupsService($config);
	$targetGroupsService->setDebug($debug);

	// Not really required but used as the classloader currently prints first time a class is loaded and it looks ugly if the class is loaded in between
	$notUsed = new com_maileon_api_targetgroups_TargetGroup();
?>
...
<?php if (isset($_POST['targetgroup_4'])) { ?>
	<li>
		...
		<?php
		$targetGroup = new com_maileon_api_targetgroups_TargetGroup();
...
<?php 
if (isset($_POST['mailings_1'])
		|| isset($_POST['mailings_2'])
		|| isset($_POST['mailings_3'])
		|| isset($_POST['mailings_4'])
		|| isset($_POST['mailings_5'])
		|| isset($_POST['mailings_6'])
		|| isset($_POST['mailings_7'])
        || isset($_POST['mailings_8'])
        || isset($_POST['mailings_9'])
        || isset($_POST['mailings_10'])
        || isset($_POST['mailings_11'])
		|| isset($_POST['mailings_12'])
		|| isset($_POST['mailings_13'])
		|| isset($_POST['mailings_14'])
		|| isset($_POST['mailings_15'])
		|| isset($_POST['mailings_16'])
		|| isset($_POST['mailings_17'])
		|| isset($_POST['mailings_18'])
		|| isset($_POST['mailings_19'])
		|| isset($_POST['mailings_20'])
		|| isset($_POST['mailings_21'])
		|| isset($_POST['mailings_22'])
		|| isset($_POST['mailings_23'])
		|| isset($_POST['mailings_24'])
		|| isset($_POST['mailings_25'])) {?>
     ...
     <td bgcolor="#dddddd" width="100%">
            ...
            <tr>
             ...
             <td align="left" valign="top"> <font data-fs-transfer-constraint="allow=&amp;mpicture=false&amp;txt=true&amp;hide=&amp;stype=&amp;mfile=false&amp;etype=&amp;up=false&amp;multi=false" data-fs-attrs="eyJsYW5ndWFnZUFiYnJldmlhdGlvbiI6IkRFIiwicmVsZWFzZSI6ZmFsc2UsImNoYW5uZWwiOjIxfQ==" data-fs-editor-type="CMS_INPUT_TEXT" data-fs-transfer-types="2243933507" data-fs-id="eyJub2RlcyI6WyJzdF9oZWFkbGluZSJdLCJpZCI6NzcyMSwic3RvcmUiOiJQQUdFU1RPUkUifQ==" data-fs-type="GADGET" style="font-size:11px;" color="#636362" size="2" face="Arial, Helvetica, Sans-Serif"><b>„The Floating Piers“ – wie Groz-Beckert Nadeln Brücken schlagen</b></font>
              <div data-fs-transfer-constraint="allow=&amp;mpicture=false&amp;txt=true&amp;hide=&amp;stype=&amp;mfile=false&amp;etype=&amp;up=false&amp;multi=false" data-fs-attrs="eyJsYW5ndWFnZUFiYnJldmlhdGlvbiI6IkRFIiwicmVsZWFzZSI6ZmFsc2UsImNoYW5uZWwiOjIxfQ==" data-fs-editor-type="CMS_INPUT_DOM" data-fs-transfer-types="2243933507" data-fs-id="eyJub2RlcyI6WyJzdF9jb250ZW50Il0sImlkIjo3NzIxLCJzdG9yZSI6IlBBR0VTVE9SRSJ9" data-fs-type="GADGET">
               ...
               <p></p>
               <p class="section"><font style="font-size:11px;" color="#5a5a5a" size="2" face="Arial, Helvetica, Sans-Serif">Ebenso zuverlässige und verlässliche Partner sind Produkte aus dem Hause Groz-Beckert die Altex bei der Bewältigung dieser immensen Aufgabe unterstützen. <br>Groz-Beckert drückt dem Projektteam bei der Umsetzung dieses spannenden Vorhabens die Daumen.</font></p>
               <p></p>
      ...
      <table align="center" border="0" cellpadding="0" cellspacing="0" width="600">
       <tbody>
        <tr>
         <td width="14"><img alt="" src="http://dev-shop1000.maileon.com:8000/fs5preview/preview/14/media/DE/current/6254/ORIGINAL/nl_spacer.gif/login.ticket=1s9lxwkxqrhh" style="display:block;" border="0" height="1" width="14"></td>
         <td align="left" bgcolor="#dddddd" valign="top"><font style="font-size:11px;" color="#636362" size="2" face="Arial, Helvetica, Sans-Serif"> <b>Der Groz-Beckert Online-Newsletter - Abonnement, Datenschutz und Feedback</b> <br> <br> Diese E-Mail wurde an [[CONTACT|EMAIL]] gesendet. Groz-Beckert sendet E-Mails immer nur nach ausdrücklicher Einwilligung des Empfängers.<br> <br> Hinweise zum Thema Datenschutz und zur Verwendung Ihrer Daten finden Sie unter den <a href="https://www.groz-beckert.com/cms/de/datenschutz?msgID=438230696&amp;adr=[[CONTACT|EMAIL]]" style="color: #636362" target="_blank" class="iline"><font color="#636362">Datenschutz-Richtlinien</font></a>.<br> Um Ihre individuellen Einstellungen zu ändern oder den Online-Newsletter abzubestellen, klicken Sie bitte <a href="http://news.groz-beckert.com/pages/de_change_profile.php5?msgID=438230696&amp;adr=[[CONTACT|EMAIL]]" style="color: #636362" target="_blank" class="iline"><font color="#636362">hier</font></a>.<br> Ihr persönliches <a href="http://news.groz-beckert.com/pages/de_feedback.php5?msgID=438230696&amp;adr=[[CONTACT|EMAIL]]" style="color: #636362" target="_blank" class="iline"><font color="#636362">Feedback</font></a> nimmt Groz-Beckert gerne entgegen.<br> <br> </font> </td>
         <td width="14"><img alt="" src="http://dev-shop1000.maileon.com:8000/fs5preview/preview/14/media/DE/current/6254/ORIGINAL/nl_spacer.gif/login.ticket=1s9lxwkxqrhh" style="display:block;" border="0" height="1" width="14"></td>
        </tr>
       </tbody>
      </table>
      <table align="center" border="0" cellpadding="0" cellspacing="0" width="600">
       <tbody>
        <tr>
         <td width="14"><img alt="" src="http://dev-shop1000.maileon.com:8000/fs5preview/preview/14/media/DE/current/6254/ORIGINAL/nl_spacer.gif/login.ticket=1s9lxwkxqrhh" style="display:block;" border="0" height="1" width="14"></td>
         <td align="left" bgcolor="#dddddd" valign="top"><font style="font-size:11px;" color="#636362" size="1" face="Arial, Helvetica, Sans-Serif"> Groz-Beckert KG | Postfach 10 02 49 | 72423 Albstadt | Germany<br> Telefon +49 7431 10-0 | Fax +49 7431 10-27 77 | <a href="mailto:contact@groz-beckert.com?msgID=438230696&amp;adr=[[CONTACT|EMAIL]]" style="color: #636362" target="_blank" class="iline"><font color="#636362">contact@groz-beckert.com</font></a> | <a href="http://www.groz-beckert.com/?msgID=438230696&amp;adr=lukas.sadurski@xqueue.de" style="color: #636362" target="_blank" class="iline"><font color="#636362">www.groz-beckert.com</font></a> <br> <br> Registrierter Firmensitz: Albstadt | Amtsgericht Stuttgart | HRA 401300<br> Umsatzsteueridentifikationsnummer: DE 144836167<br> </font> </td>
         <td width="14"><img alt="" src="http://dev-shop1000.maileon.com:8000/fs5preview/preview/14/media/DE/current/6254/ORIGINAL/nl_spacer.gif/login.ticket=1s9lxwkxqrhh" style="display:block;" border="0" height="1" width="14"></td>
        </tr>
       </tbody>
      </table>
...
<?php	
	...
	$fields = array(com_maileon_api_mailings_MailingFields::$STATE,
					com_maileon_api_mailings_MailingFields::$TYPE, 
					com_maileon_api_mailings_MailingFields::$NAME,
					com_maileon_api_mailings_MailingFields::$SCHEDULE_TIME);
...
POST set sender:
<?php	
$response = $mailingService->setSender($TESTDATA['mailingId'], "marcusX@api.testing.news-mailer.eu");
checkResult($response);
?>
</li>
...
<?php } if (isset($_POST['mailings_15'])) { ?>
	<li>
		POST Copy Mailing:
		<?php
		$response = $mailingService->copyMailing(11078);
		checkResult($response);
		?>
	</li>
...
<?php } if (isset($_POST['mailings_21'])) { ?>
	...
	<li>
		...
		$properties = array(
			new com_maileon_api_mailings_CustomProperty("testprop1","testval1"),
			new com_maileon_api_mailings_CustomProperty("testprop2","testval2")
		);
		...
		// Add single property
		$response = $mailingService->addCustomProperties($mailingId, new com_maileon_api_mailings_CustomProperty("testprop3","testval3"));
		checkResult($response);
		?>
	</li>
<?php } if (isset($_POST['mailings_24'])) { ?>
	<li>
		...
		$response = $mailingService->updateCustomProperty($mailingId, new com_maileon_api_mailings_CustomProperty("testprop2","testval2.1"));
		checkResult($response);
		?>
	</li>
...
<?php 
if (isset($_POST['reports_1'])
	|| isset($_POST['reports_2'])
	|| isset($_POST['reports_3'])
	|| isset($_POST['reports_4'])
	|| isset($_POST['reports_5'])
	|| isset($_POST['reports_6'])
	|| isset($_POST['reports_7'])
	|| isset($_POST['reports_8'])
	|| isset($_POST['reports_9'])
	|| isset($_POST['reports_10'])) {?>
...
<?php
	...
	$contactIds = null;
	$contactEmails = array('benjamin.burger@tripicchio.de');//array('mahlemeier@mamo.de');
	$contactExternalIds = null;
...
<?php 
if (isset($_POST['transactions_1'])
    || isset($_POST['transactions_2'])
    || isset($_POST['transactions_3'])
	|| isset($_POST['transactions_4'])
	|| isset($_POST['transactions_4_1'])
	|| isset($_POST['transactions_4_2'])
    || isset($_POST['transactions_5'])
    || isset($_POST['transactions_6'])
	|| isset($_POST['transactions_6_1'])
	|| isset($_POST['transactions_6_2'])
    || isset($_POST['transactions_7'])
	|| isset($_POST['transactions_8'])
	|| isset($_POST['transactions_9'])
	|| isset($_POST['transactions_10'])
) { ?>
...
<?php } if (isset($_POST['transactions_4'])) { ?>
	<li>
		...
		<?php
		$attribute_1 = new com_maileon_api_transactions_AttributeType(null, "date", com_maileon_api_transactions_DataType::$TIMESTAMP, true);

		$attributes = array($attribute_1);
		$trt = new com_maileon_api_transactions_TransactionType(null, "TestType1", $attributes, null, true);
...
<?php } if (isset($_POST['transactions_4_1'])) { ?>
	<li>
		...
		<?php
		$attributes = array();
//		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "gender", com_maileon_api_transactions_DataType::$STRING, false));
//		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "title", com_maileon_api_transactions_DataType::$STRING, false));
//		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "first_name", com_maileon_api_transactions_DataType::$STRING, true));
//		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "last_name", com_maileon_api_transactions_DataType::$STRING, true));
//		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "phone", com_maileon_api_transactions_DataType::$STRING, true));
//		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "webshop_id", com_maileon_api_transactions_DataType::$STRING, true));
//		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "phone_contact", com_maileon_api_transactions_DataType::$STRING, true));
//		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "mail_contact", com_maileon_api_transactions_DataType::$STRING, true));
//		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "language", com_maileon_api_transactions_DataType::$STRING, true));
//		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "b2c", com_maileon_api_transactions_DataType::$STRING, true));
//		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "aktion", com_maileon_api_transactions_DataType::$STRING, true));
//		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "customer_no", com_maileon_api_transactions_DataType::$STRING, true));
//		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "order_no", com_maileon_api_transactions_DataType::$STRING, true));
//		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "currency", com_maileon_api_transactions_DataType::$STRING, true));
//		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "billing_address.name", com_maileon_api_transactions_DataType::$STRING, true));
//		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "billing_address.street1", com_maileon_api_transactions_DataType::$STRING, true));
//		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "billing_address.street2", com_maileon_api_transactions_DataType::$STRING, true));
//		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "billing_address.zip", com_maileon_api_transactions_DataType::$STRING, true));
//		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "billing_address.city", com_maileon_api_transactions_DataType::$STRING, true));
//		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "shipping_address.name", com_maileon_api_transactions_DataType::$STRING, true));
//		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "shipping_address.street1", com_maileon_api_transactions_DataType::$STRING, true));
//		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "shipping_address.street2", com_maileon_api_transactions_DataType::$STRING, true));
//		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "shipping_address.zip", com_maileon_api_transactions_DataType::$STRING, true));
//		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "shipping_address.city", com_maileon_api_transactions_DataType::$STRING, true));
//		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "items", com_maileon_api_transactions_DataType::$JSON, true));
//		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "order_date", com_maileon_api_transactions_DataType::$STRING, true));
//		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "total", com_maileon_api_transactions_DataType::$STRING, true));
//		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "payment_type", com_maileon_api_transactions_DataType::$STRING, true));
//		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "voucher_code", com_maileon_api_transactions_DataType::$STRING, false));
//		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "incentive.type", com_maileon_api_transactions_DataType::$STRING, false));
//		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "incentive.value", com_maileon_api_transactions_DataType::$STRING, false));
//		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "incentive.code", com_maileon_api_transactions_DataType::$STRING, false));
//		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "incentive.validity", com_maileon_api_transactions_DataType::$STRING, false));


		// Reminder Mails
		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "customer.gender", com_maileon_api_transactions_DataType::$STRING, false));
		...
		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "customer.number", com_maileon_api_transactions_DataType::$STRING, false));
		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "reminder.unsubscribe_link", com_maileon_api_transactions_DataType::$STRING, false));
		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "reminder.reorder_all_products", com_maileon_api_transactions_DataType::$STRING, false));
		array_push($attributes, new com_maileon_api_transactions_AttributeType(null, "reminder.items", com_maileon_api_transactions_DataType::$JSON, false));
		$trt = new com_maileon_api_transactions_TransactionType(null, "reorder_reminder", $attributes);
...
<?php } if (isset($_POST['transactions_4_2'])) { ?>
	<li>
		...
		<?php
		$attributes = array();
		$trt = new com_maileon_api_transactions_TransactionType(null, "ArchivalDurationApiTest", $attributes, 7);
...
<?php
    $transaction = new com_maileon_api_transactions_Transaction();
    $transaction->import = new com_maileon_api_transactions_ImportReference();
    $transaction->import->contact = new com_maileon_api_transactions_ImportContactReference();
    $transaction->import->contact->email = $TESTDATA['transactionUserEmail'];
    $transaction->import->contact->external_id = "ztfhtfg";
	$transaction->import->contact->permission = com_maileon_api_contacts_Permission::$SOI->getCode();
    $transaction->type = $TESTDATA['transactionTypeId'];
...
<?php
	$blacklistsService = new com_maileon_api_blacklists_BlacklistsService($config);
